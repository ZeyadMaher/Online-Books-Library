...
urlpatterns = [
    ...
    path('viewbookstudent', views.viewbook_viewstudent),
    path('issuebook', views.issuebook_view),
    path('viewissuedbook', views.viewissuedbook_view),
    path('viewstudent', views.viewstudent_view),
    path('viewissuedbookbystudent', views.viewissuedbookbystudent),
    path('borrowbookstudent', views.borrowbook_view),
    path('updateprofilestudent', views.updateprofilestudent,name="updateprofilestudent"),
